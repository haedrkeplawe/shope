...
/*
  ...
  2) ⚠️ استثناء صريح (بطلب من صاحب المشروع): كارتي "الأعضاء المشتركون"
     و"أرباح التسويق بالعمولة" أرقام ثابتة (Hardcoded) حاليًا - نظامي
     "العضويات والاشتراكات" و"التسويق بالعمولة" لسه ما اتبنوا بالسستم
     (شوف navItems.js: /memberships و/affiliate-marketing لسه صفحات
     فارغة مؤقتة). لما ينبنوا فعليًا، بيصير استبدال هالقيمتين بحساب حقيقي
     بنفس أسلوب باقي الكروت بالضبط - باقي الكود هون جاهز لهيك من غير ما
     يحتاج أي تغيير تاني.
...
/*
  -------------------- ثوابت الأعضاء والتسويق بالعمولة (Hardcoded مؤقتًا) --------------------
  شوف الشرح بالأعلى (نقطة 2) - القيم هون بس عرض توضيحي لحد ما ينبنى
  النظامين فعليًا بالباك إند
*/
const PLACEHOLDER_SUBSCRIBED_MEMBERS = { value: 312, changePercent: 15.0 };
const PLACEHOLDER_AFFILIATE_PROFIT = { value: 8920, changePercent: 9.8 };
...
exports.getDashboardOverview = async (req, res) => {
  try {
    ...
    const stats = {
      ...
      affiliateProfit: {
        value: PLACEHOLDER_AFFILIATE_PROFIT.value,
        change: PLACEHOLDER_AFFILIATE_PROFIT.changePercent,
        changeIsPercent: true,
      },
    };
