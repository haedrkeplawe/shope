...
exports.createStaff = async (req, res) => {
  try {
    ...
    // ⚠️ تحقق من صيغة الرقم قبل أي شي - نفس سبب التحقق بـ
    // registerCustomer بالضبط: Aman Gate بيرسل بس للأرقام السورية
    // (محليًا 09XXXXXXXX متل الفورم فوق، أو دوليًا 963+XXXXXXXXX)
    if (!smsProvider.isValidSyrianPhone(phone)) {
      return res.status(400).json({
        message: "رقم الجوال غير صالح - الرجاء إدخال رقم سوري صحيح",
      });
    }
