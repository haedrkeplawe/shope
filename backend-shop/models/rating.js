...
/*
  ...
  -------------------- تحديث: موافقة الأدمن قبل النشر --------------------
  approvalStatus: أي تقييم جديد (أو إعادة تقييم) بيبدأ "قيد المراجعة"
  (pending) افتراضيًا - ما بيظهر بقائمة "آراء الزبائن" العامة بصفحة
  المنتج، ولا بيدخل بحساب متوسط/عدد التقييمات (ratingAverage/ratingCount
  بموديل Product) إلا بعد ما الأدمن يوافق عليه صراحة من صفحة "التقييمات
  والتعليقات" بلوحة التحكم (controllers/adminRating.controller.js).
  لو الأدمن رفضه (rejected) بيضل محفوظ بالداتابيز للمرجعية بس برضو مش
  ظاهر للعامة أبدًا. إعادة التقييم (تعديل نجوم/تعليق موجودين) بترجّع
  الحالة لـ"قيد المراجعة" من جديد تلقائيًا - عشان أي تعديل بالمحتوى
  يمر على مراجعة الأدمن من جديد، مش يضل معتمد بمحتوى ما شافه الأدمن أصلاً
*/
