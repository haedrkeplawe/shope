...
/*
  ProductCard
  - كرت منتج مشترك - مستخدم هلق بقسم "جديدنا" بالصفحة الرئيسية، صفحة
    المفضلة، ومنتجات "ذات صلة" بصفحة تفاصيل المنتج - ورح يترستخدم لاحقًا
    بصفحة المتجر الكاملة وأي مكان تاني بيعرض منتجات
  - زر القلب مربوط فعليًا بـ FavoritesContext - بيوقف انتشار الحدث عشان
    ...
    بالمفضلة
  - التقييم (نجوم + عدد) بيظهر بس لو المنتج أصلاً عليه تقييم واحد عالأقل
    (ratingCount > 0) - نفس بيانات ratingAverage/ratingCount المحسوبة
    Cache بموديل Product (شوف controllers/shop.controller.js → submitRating)
*/
      ...
      <div className="product-card-info">
        ...
        {ratingCount > 0 && (
          <div className="product-card-rating">
            ...
            <span className="product-card-rating-value">{ratingAverage}</span>
