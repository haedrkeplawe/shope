  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/*
          ⚠️ تحديث جذري (تصفح بدون تسجيل دخول): كل محتوى الموقع بقى ملفوف
          بـ MainLayout (هيدر + قائمة + فوتر) بغض النظر عن تسجيل الدخول -
          الصفحات "العامة" (تصفح بحت) بترسم مباشرة هون بدون أي حماية،
          والصفحات يلي فعليًا بتتطلب حساب (حسابي، إتمام الطلب، الطلبات،
          المفضلة، الإشعارات...) ملفوفة إضافيًا بـ ProtectedRoute جوّا
          نفس الـMainLayout - فلو الزائر ضغط عليها بيترجّع لـ/login (مع
          حفظ مكانه الأصلي، شوف ProtectedRoute.jsx) وبيرجعله فورًا بعد
          ما يسجّل دخول
        */}
        <Route element={<MainLayout />}>
          ...
          */}
          ...
          <Route path="/brands" element={<Shop key="brands" preset="none" />} />
          ...
          {/* ⚠️ السلة نفسها عامة - زائر بلا حساب بيقدر يشوف سلته ويعدّلها
              (localStorage)، تسجيل الدخول بيصير مطلوب بس لحظة الضغط على
              "إتمام الطلب" (محمية تحت) - شوف شرح كامل بـ Cart.jsx */}
          ...
          <Route element={<ProtectedRoute />}>
            ...
            <Route path="/account/marketer" element={<MarketerDashboard />} />
            ...
            <Route
              path="/notifications"
              element={<Notifications title="الإشعارات" />}
            />
          </Route>
        </Route>
      </Routes>
