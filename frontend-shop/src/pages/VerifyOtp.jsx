...
/*
  ⚠️ تحديث (ربط SMS فعلي - Aman Gate): otp هلق ممكن يوصل عبر
  location.state من صفحة تسجيل الدخول (Login.jsx بيمرره من رد
  /store/login مباشرة) - موجود بس لأنه الباك إند بمرحلة الاختبار الحالية
  (SMS_DEBUG_MODE) عم يرجّعه صراحة بالرد. لو موجود، منعرضه فعليًا بدل
  التلميح الثابت "استخدم الرمز 123456" تحت (يلي بيضل شغال أصلاً كـ
  fallback بالباك إند حتى لو ما ظهر هون)
*/
const VerifyOtp = () => {
