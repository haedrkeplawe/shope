...
/*
  ...
  ⚠️ colorHexMap بقى بيتبعت كـ prop من الصفحة الأب (Products.jsx) بدل ما يكون
  ثابت مستورد من Productoptions.js، لأن الألوان بقت تُدار من الفلاتر المتقدمة
  والأدمن ممكن يضيف ألوان جديدة بأي وقت
*/
const ProductCard = ({
  product,
  colorHexMap = {},
